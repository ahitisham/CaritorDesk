...
export class EmployeeSnap extends React.Component{
	constructor(){
		super();
		//define state
	...
	handleSubmit(){
		...
		axios({
              method: 'post',
              url: 'http://localhost:1336/add/employee',
		...
		return(
			<div className="panel-group ">
			    <div className="panel panel-default bt_Bdr_org">
			      	<div className="panel-heading"><h3 className="panel-title">Employee Profile Snapshot</h3></div>
			      <div className="panel-body">
					   ...
					   <Form onSubmit={this.handleSubmit}>
						...
						<Form.Group widths='equal'>
						<Form.Field control={Select} label='Emp Role' placeholder='Emp Role' options={empRole} value={this.state.empRole} onChange={this.empRoleHandleChange}/>
						<Form.Field control={Select} label='Total Exp' placeholder='Total Exp' options={empExpYear} value={this.state.empExpYear} onChange={this.empExpYearHandleChange}/>
						<Form.Field control={DatePicker} label='Join Date' placeholder='Join Date' selected={this.state.joinDate} onChange={this.joinDateHandleChange}/>
						</Form.Group>


						<Form.Group widths='equal'>
						<Form.Field control={Input} label='Mobile no' placeholder='Mobile no' value={this.state.mobile} onChange={this.mobileHandleChange}/>
						<Form.Field control={Input}  label='Email' placeholder='Email' value={this.state.email} onChange={this.emailHandleChange}/>
						<Form.Field control={Select} label='Gender' options={gender} placeholder='Gender' value={this.state.gender} onChange={this.genderHandleChange} />
						</Form.Group>


						<Form.Group widths='equal'>
						<Form.Field control={Dropdown} fluid multiple selection label='KeySkills' placeholder='KeySkills' value={this.state.KeySkills} onChange={this.onSkillClick} options={KeySkills} />
						</Form.Group>
